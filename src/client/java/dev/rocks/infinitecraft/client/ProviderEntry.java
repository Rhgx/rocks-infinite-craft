...
final class ProviderEntry extends SelectionEntry<ProviderEntry.Provider> {
    ...
    @Override protected int labelInset() { return 36; }
    @Override protected int buttonHeight() { return 32; }
    @Override protected Component optionText(Provider option) {
        return Component.literal("    " + option.label).withColor(option.color);
    }

    @Override protected void drawOption(GuiGraphicsExtractor graphics, Button button, Provider option, int index, int labelX) {

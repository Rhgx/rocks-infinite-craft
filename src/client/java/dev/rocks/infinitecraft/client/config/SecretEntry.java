...
final class SecretEntry extends AbstractConfigListEntry<String> {
    ...
    @Override
    public String getValue() { return field.getValue(); }
    @Override
    public Optional<String> getDefaultValue() { return Optional.of(""); }
    @Override
    public boolean isEdited() { return !original.equals(getValue()); }
    @Override
    public int getItemHeight() { return 24; }
    @Override
    public List<? extends GuiEventListener> children() { return List.of(field, clear); }
    @Override
    public List<? extends NarratableEntry> narratables() { return List.of(field, clear); }

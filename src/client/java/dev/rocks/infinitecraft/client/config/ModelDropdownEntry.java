...
final class ModelDropdownEntry extends SelectionEntry<String> {
    ...
    private final Map<ProviderEntry.Provider, String> selections = new EnumMap<>(ProviderEntry.Provider.class);
    ...
    ModelDropdownEntry(String initial, Supplier<ProviderEntry.Provider> provider,
            Supplier<String> ollamaUrl, Supplier<String> customValue) {

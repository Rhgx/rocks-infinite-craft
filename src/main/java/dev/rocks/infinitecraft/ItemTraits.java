...
final class ItemTraits {
    static final String KEY = "infinitecraft_traits";

    static List<String> inherited(ItemStack... inputs) {
    ...
    static boolean apply(ItemStack output, ItemStack first, ItemStack second, List<String> chosen, int limit) {

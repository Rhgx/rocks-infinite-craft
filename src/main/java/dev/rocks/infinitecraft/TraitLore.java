...
final class TraitLore {
    ...
    static boolean add(ItemStack stack, List<String> traits) {
        return add(stack, traits, Map.of());
    }

    static boolean add(ItemStack stack, List<String> traits, Map<String, String> activations) {

...
final class FusionOrigin {
    static final String FIRST = "infinitecraft_origin_first";
    static final String SECOND = "infinitecraft_origin_second";
    private static final String PREFIX = "Made from ";

    private FusionOrigin() {}

    static boolean valid(net.minecraft.nbt.CompoundTag tag) {
    ...
    static ItemStack strip(ItemStack source) {

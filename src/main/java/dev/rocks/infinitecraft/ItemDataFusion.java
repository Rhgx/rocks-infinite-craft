...
final class ItemDataFusion {
    ...
    static boolean specialIngredient(ItemStack stack) {
        return specialIngredient(stack, true, true, true, true);
    }

    static boolean specialIngredient(ItemStack stack, boolean rarity, boolean enchantments, boolean potions, boolean custom) {
    ...
    static ItemStack brew(PotionBrewing brewing, ItemStack first, ItemStack second) {
    ...
    static ItemStack prepare(ItemStack target, ItemStack first, ItemStack second, boolean brewed) {
    ...
    private static boolean mergeTraitModifiers(ItemStack result, ItemStack first, ItemStack second) {
        ...
        for (var input : List.of(first, second)) {
            ...
            for (var entry : modifiers.modifiers()) {
                ...
                if (previous != null && (!previous.attribute().equals(entry.attribute()) || !previous.modifier().equals(entry.modifier()) || previous.slot() != entry.slot())) return false;
            }
        }

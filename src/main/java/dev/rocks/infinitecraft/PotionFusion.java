...
final class PotionFusion {
    private PotionFusion() {}

    static List<List<String>> describe(ItemStack first, ItemStack second) {
        var descriptions = new java.util.ArrayList<List<String>>();
    ...
    static Map<String, List<String>> options() {
    ...
    static boolean merge(ItemStack result, ItemStack first, ItemStack second) {
